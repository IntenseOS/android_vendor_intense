...
ALARM_PATH := vendor/intense/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/intense/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/intense/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/intense/prebuilt/common/media/audio/ui
