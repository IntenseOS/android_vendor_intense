...
ifeq ($(INTENSE_BUILDTYPE), RELEASE)
    ifndef TARGET_VENDOR_RELEASE_BUILD_ID
        INTENSE_VERSION := $(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)-$(INTENSE_BUILD)
    else
        ifeq ($(TARGET_BUILD_VARIANT),user)
            INTENSE_VERSION := $(PRODUCT_VERSION_MINOR)-$(TARGET_VENDOR_RELEASE_BUILD_ID)-$(INTENSE_BUILD)
        else
            INTENSE_VERSION := $(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)-$(INTENSE_BUILD)
        endif
    endif
else
    INTENSE_VERSION := $(PRODUCT_VERSION_MINOR)-$(shell date -u +%Y%m%d)-$(INTENSE_BUILDTYPE)$(INTENSE_EXTRAVERSION)-$(INTENSE_BUILD)
endif
